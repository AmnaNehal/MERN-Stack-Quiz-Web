...
\
🔗 Live Demo: (https://mern-stack-quiz-web.vercel.app)  
...
✔ Take quizzes and see results in real-time  
✔ Clean, functional UI (Desktop-only)  
...
```bash
git clone https://github.com/AmnaNehal/MERN-Stack-Quiz-Web.git
