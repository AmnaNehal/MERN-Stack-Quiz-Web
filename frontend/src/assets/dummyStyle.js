export const navbarStyles = {
  // Main nav container
  nav: "w-full bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 shadow-2xl py-1 sm:py-2 px-4 sm:px-6 lg:px-10 relative overflow-visible",
  ...
  // Floating bubbles
  bubble1: "hidden md:block absolute top-0 left-1/4 w-36 h-36 sm:w-40 sm:h-40 bg-blue-200 rounded-full mix-blend-multiply filter blur-2xl opacity-40 animate-float-slow",
  ...
  bubble3: "hidden md:block absolute top-0 left-20 w-20 h-20 md:w-24 md:h-24 bg-indigo-200 rounded-full mix-blend-multiply filter blur-2xl opacity-40 animate-float-slowest",
  
  // Main container
  container: "max-w-6xl mx-auto flex items-center justify-between relative z-10 mt-4",
  
  // Logo section
  logoContainer: "flex items-center justify-start h-23",
  ...
  logoText: "text-white text-xs font-bold whitespace-nowrap",

  
  // Title section
  titleContainer: "absolute top-1/1 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center px-4",
  ...
  // Button styles
  resultsButton: "inline-flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r from-emerald-500 to-green-500 text-white text-sm font-medium shadow-md cursor-pointer transform transition focus:outline-none focus:ring-2 focus:ring-offset-5 focus:ring-indigo-400",
  ...
  loginButton: "inline-flex cursor-pointer items-center gap-2 px-7 py-2 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 text-white text-sm font-medium shadow-md transform transition focus:outline-none focus:ring-2 focus:ring-offset-5 focus:ring-indigo-400",
  buttonIcon: "h-4 w-4 flex-shrink-0",
  rightButtons: "ml-auto flex items-center space-x-3",
  
  // Mobile menu
  mobileMenuContainer: "flex items-center",
...
export const loginStyles = {
  ...
  // Form container
  formContainer: "w-full max-w-sm pt-4 sm:max-w-md md:max-w-md lg:max-w-md relative z-20",
  form: "w-full",
...
export const signupStyles = {
  ...
  animatedBorder: "rounded-3xl p-1 sm:p-[2px] bg-gradient-to-r from-purple-400 via-indigo-400 to-sky-400 animate-border",
  formContent: "bg-white/95 backdrop-blur-sm rounded-3xl p-4 md:p-6 shadow-xl",
