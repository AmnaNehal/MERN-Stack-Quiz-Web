...
const Signup = ({ onSignupSuccess = null }) => {
  ...
  // email validation function also validating name email and password length
      ...
      <div className={signupStyles.formContainer}>
          ...
          <div className={signupStyles.animatedBorder}>
            <div className={signupStyles.formContent}>
              ...
              <p className={signupStyles.subtitle}>
                Sign in to continue to Quiz App.Light , clean UI - smooth micro
                animations and easy animations
              </p>
        ...
        <div className={signupStyles.loginPromptContainer}>
            <div className={signupStyles.loginPromptContent}>
                ...
                <Link to='/login' className={signupStyles.loginPromptLink}>Login
                </Link>
            </div>
        </div>
      </div>
