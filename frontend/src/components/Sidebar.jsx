...
const Sidebar = () => {
  ...
  // if the sidebar is open and inner width is less than 768px then i will collapse
  useEffect(() => {
  ...
  //here this function will handle what you select the teac
